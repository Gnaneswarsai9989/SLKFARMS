...
export const Icon = {
  ...
  road: (p) => (
    <svg viewBox="0 0 24 24" {...base} {...p}><path d="m4 19 4-14M20 19l-4-14M12 5v2M12 11v2M12 17v2" /></svg>
  ),
  star: (p) => (
  ...
  instagram: (p) => (
    <svg viewBox="0 0 24 24" {...base} {...p}><rect width="20" height="20" x="2" y="2" rx="5" ry="5" /><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" /><line x1="17.5" x2="17.51" y1="6.5" y2="6.5" /></svg>
  ),
  facebook: (p) => (
